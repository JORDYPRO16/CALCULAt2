Public Class Calculadora
    ...
    End Sub
    'se le agrega un numero a cada boton
    ...
    Private Sub RealizarOperacion(operador As String)
        'se va realizar la operacion que el usuario vaya a desear calcular
        Select Case operador
            ...
            Case "x"
                resultado = (numero1 * numero2).ToString()
                'en este caso se hace la division y se agrega un codigo que no nos va permitir dividir entre 0
            Case "%"
                If numero2 <> 0 Then
    ...
    Private Sub BtnCalcular_Click(sender As Object, e As EventArgs) Handles BtnCalcular.Click
        ...
        '' Comprobamos si hay al menos dos elementos en el arreglo "ElementosEncadena" y si el segundo elemento no está vacío
        If (ElementosEncadena.Length > 1 And ElementosEncadena(1) <> "") Then

            'se crea una nueva variable y le asignamos el segundo elemento de "ElementosEncadena" después de eliminar espacios en blanco 
    ...
    'Estos procedimientos se utilizan para configurar la operación que se va a realiar cuando se haga clic en los botones
    'Y tambien se va agregrar el simbolo de la operacion 
    ...
    Private Sub BtnborrarTD_Click(sender As Object, e As EventArgs) Handles BtnborrarTD.Click
        'este nos permite borrar todos los numeros que hayan en el panel 
        TxtPantalla.Text = "      "
    End Sub

    Private Sub BtnBorrar1_Click(sender As Object, e As EventArgs) Handles BtnBorrar1.Click
        'esto nos va permitir borrar numero por numero del panel
